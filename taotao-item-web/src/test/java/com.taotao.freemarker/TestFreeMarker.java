...
public class TestFreeMarker {
    ...
    public void testFreeMarker() throws Exception {
        ...
        // 3.设置模板所在的路径
        configuration.setDirectoryForTemplateLoading(new File("G:\\IDEAWorkSpace\\taotao\\taotao-item-web\\src\\main\\webapp\\WEB-INF\\ftl"));
        // 4.设置模板的字符集，一般为utf-8
        ...
        // pojo类型
        Student student = new Student(1, "张三", 15, "湖南技术院校");
